...
/**
 * Write a description of ManyFunctions here.
 * 
 ...
 * 2. Figure out what should be in the _____ areas.  Fix them.
 * 3. Compile the code to check your work.
 * 4. Figure out what code belongs in the // TODO areas.  Write that code.
...
public class ManyFunctions
{
    ...
    {
        // TODO
        if ((java.lang.Character.toLowerCase(letter) == 'a' ) || (java.lang.Character.toLowerCase(letter) == 'e' )
        ||(java.lang.Character.toLowerCase(letter) == 'i' )|| (java.lang.Character.toLowerCase(letter) == 'o' )
        ||(java.lang.Character.toLowerCase(letter) == 'u' ))
        return true;
        return false;
    }
